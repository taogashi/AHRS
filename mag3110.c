...
//	mag[0]=(s16)((-raw_s16[0]+54)*0.903);
//	mag[1]=(s16)((raw_s16[1]+105.5)*0.96142);
//	mag[2]=(s16)((raw_s16[2]+2696.8)*0.94086);	

	mag[0]= (-raw_s16[0]+7002)*0.8952;
	mag[1]= (raw_s16[1]-26899)*1.0602;
	mag[2]= (raw_s16[2]+1064)*0.8806;	
}
